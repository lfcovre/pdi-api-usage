...
rem Ex02 - Pentaho Server + repository explicito + Job
rem O parametro rep seleciona um repository conhecido pelo processo do Pentaho Server.
...
rem   --user HTTP_USER:HTTP_PASSWORD : autentica no Pentaho Server.
rem   rep                            : nome do repository conhecido pelo PDI.
rem   user / pass                    : credenciais para conectar ao repository.
rem   job                            : caminho logico do Job no repository.
