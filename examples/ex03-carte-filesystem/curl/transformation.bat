...
rem Ex03 - Carte Standalone + filesystem + Transformation
rem O caminho fisico e interpretado pelo processo Carte.
...
echo ============================================================
echo Ex03 - Carte Standalone / Filesystem / Transformation
